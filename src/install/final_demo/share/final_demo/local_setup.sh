...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros_ws/src/install/final_demo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/final_demo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/final_demo/environment/path.sh"
