...
class RectangleController(Node):
        ...
        def odom_callback(self, msg):
                ...
                if distance_error < dist_thresh and abs(heading_error) < 0.15:
                        if self.current_waypoint_index == len(self.waypoints)-1:
                                cmd_vel_msg = Twist()
                                ...
                                self.get_logger().info(f'RECTANGLE FOLLOW TEST: Robot reach all the 4 waypoints using the controller, Rectangle Completed !!', once=True)
                        else:
